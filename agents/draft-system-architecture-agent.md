...
description: Creates the first draft of a system architecture document covering language, frameworks, repository structure, tooling, and cross-cutting standards.
