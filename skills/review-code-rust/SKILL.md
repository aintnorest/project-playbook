...
description: "Find consequential behavior defects and Rust-specific ownership, API, and invariant risks in the requested scope. Inspect other languages only at connected contracts needed to assess the Rust behavior."
hide: true
---
