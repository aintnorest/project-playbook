...
description: "Find consequential behavior defects and concrete maintenance burdens in the requested TypeScript scope. Preserve sound existing designs and inspect other languages only far enough at real connection points to judge the TypeScript contract."
hide: true
---
